...
const SocialLinks: FC<SocialLinksProps> = ({ className = "" }) => {
 return (
  <ul className={cn(styles.social, className)}>
   <li>
    <a href="https://instagram.com/newaction_lc?igshid=ZDdkNTZiNTM=" target="_blank" rel="noreferrer">
   ...
   <li>
    <a href="https://t.me/newaction_lc" target="_blank" rel="noreferrer">
     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   <li>
    <a href="https://www.youtube.com/@newaction_lc" rel="noreferrer" target="_blank">
     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
